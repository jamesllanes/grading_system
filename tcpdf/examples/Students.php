...
<div class="pageContent"><?php
	...
	{
		echo "<table border=1 width=60% style='margin-left:240px;margin-top:50px'>";
		echo "<th>List of Students<br></th>";
		echo "</table>";
		echo "<table border=1 width=60% style='margin-left:240px;'>";
