...
<div class="pageContent">
	<form action="Insertion_of_Grades.php" method="POST">
		<table border=1 width=50% style='margin-left:240px;margin-top:50px'>
			<tr>	
				<td colspan=2><center><b>Final</b></center></td>
			</tr>
			<tr>
				<td><b>Attendance:</b></td>
				<td><input type="text" name="fattd" style="width:99%" /></td>
			</tr>
			<tr>
				<td><b>Values and Behavior:</b></td>
				<td><input type="text" name="fvb" style="width:99%" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="fx1" style="width:99%" /></td>
			</tr>
			<tr>
				<td><b>Exercise 2:</b></td>
				<td><input type="text" name="fx2" style="width:99%" /></td>
			</tr>
			<tr>
				<td><b>Exercise 3:</b></td>
				<td><input type="text" name="fx3" style="width:99%"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td><b>Quiz 1:</b></td>
				<td><input type="text" name="fq1" style="width:99%" /></td>
			</tr>
			<tr>
				<td><b>Quiz 2:</b></td>
				<td><input type="text" name="fq2" style="width:99%" /></td>
			</tr>
			<tr>
				<td><b>Quiz 3:</b></td>
				<td><input type="text" name="fq3" style="width:99%" /></td>
			</tr>
			<tr>
				<td><b>Average:</b></td><td></td>
			</tr>	
			<tr>
				...
				<td><input type="text" name="fexam" style="width:99%" /></td>
			</tr>
			<tr>
				<td><b>Percentage(%):</b></td><td></td>
			</tr>	
			<tr>
				<td><b>Final Grade:</b></td><td></td>
			</tr>
			<tr>
