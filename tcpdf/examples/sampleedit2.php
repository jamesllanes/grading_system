...
$tblheader ='<table border="1" cellpadding="2" cellspacing="2" align="center">';
$tblfooter = '</table>';
$tblbody = '
 <tr nobr="true">
...
$query=mysql_query("SELECT * FROM grades WHERE section_name= '$section_name'");
while($row = mysql_fetch_array($query))
{
	...
	$tblgrades = '<td width="7%">'.$studno.'</td>
	<td width="4%">'.$mattd.'</td>
	<td width="5%">'.$mvb.'</td>
	<td width="5%">'.$mexercises.'</td>	
	<!--<td width="5%">'.$mexercises[0].$mexercises[1].'</td>-->
	<td width="5%">'.$mxave.'</td>
	<td width="4.5%">'.$mcs.'</td>
...
$pdf->writeHTML($tblheader . $tblbody . $tblgrades . $tblfooter, true, false, false, false, '');
