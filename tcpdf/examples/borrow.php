...
$tbl1 .= '<tr style="background-color:#000000;color:#FFFF00;"><td width="90">' . "Borrow ID" . '</td><td width="90">' . "Member ID" . '</td><td width="90">' . "Date borrowed " . '</td><td width="120">' . "Due Date" . '</td></tr>';
...
//     $index = $row['borrow'];
	 ...
	 $tbl .= '<tr><td width="90">' . $borrow_id . '</td><td width="90">' . $member_id . '</td><td width="90">' . $date_borrow . '</td><td width="120">' . $due_date . '</td></tr>';
}
