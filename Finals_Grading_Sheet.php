	...
	&ctr_exer=<?php echo $ctr_exer?>&ctr_quiz=<?php echo $ctr_quiz?>" method="POST">
		<table width=45% style='margin-left:480px;margin-top:50px'>
			...
			<tr>
				...
				<td colspan=2><input type="text" name="fattd" style="width:99%"/></td>
			</tr>
			<tr>
				<td colspan=2><b>Values and Behavior:</b></td>
				<td colspan=2><input type="text" name="fvb" style="width:99%" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan=4>
					<input type="button" class='button' value="Add Exercise" name="add_exer" style="width:40%" onclick="location='Finals_Grading_Sheet.php?Course_Code=<?php echo $_SESSION['Course_Code']?>&studno=<?php echo $_SESSION['studno']?>&chk=0&ctr_exer=<?php echo $ctr_exer+1?>&ctr_quiz=<?php echo $ctr_quiz?>'"/>
					<?php
					if(!isset($_POST['add_exer']))
						{
							if($ctr_exer>1)
							{
							?>
							<input type="button" class='button' value="Remove Exercise" name="remove_exer" style="width:40%" onclick="location='Finals_Grading_Sheet.php?Course_Code=<?php echo $_SESSION['Course_Code']?>&studno=<?php echo $_SESSION['studno']?>&chk=0&ctr_exer=<?php echo $ctr_exer-1?>&ctr_quiz=<?php echo $ctr_quiz?>'"/>
							<?php }
						}?>
				</td>
			</tr><?php
			...
			<tr>
				<td colspan=4>
					<input type="button" class='button'value="Add Quiz" name="add_quiz" style="width:40%" onclick="location='Finals_Grading_Sheet.php?Course_Code=<?php echo $_SESSION['Course_Code']?>&studno=<?php echo $_SESSION['studno']?>&chk=0&ctr_exer=<?php echo $ctr_exer?>&ctr_quiz=<?php echo $ctr_quiz+1?>'"/>
					<?php
					if(!isset($_POST['add_quiz']))
						{
							if($ctr_quiz>1)
							{
							?>
							<input type="button" class='button' value="Remove Quiz" name="remove_quiz" style="width:40%" onclick="location='Finals_Grading_Sheet.php?Course_Code=<?php echo $_SESSION['Course_Code']?>&studno=<?php echo $_SESSION['studno']?>&chk=0&ctr_exer=<?php echo $ctr_exer?>&ctr_quiz=<?php echo $ctr_quiz-1?>'"/>
							<?php }
						}?>
				</td>
			</tr><?php
			...
			<tr>
				...
				<td colspan=2><input type="text" name="fexam" style="width:99%" /></td>
			</tr>
			<tr>
				<td colspan=4 align=right>
					<input type="hidden" name="Course_Code" value="<?php echo $_SESSION['Course_Code']?>"/><?php
						...
						{?>
							<input type="submit" class='button' value="Submit" onclick="location='Final_Insertion_of_Grades.php?Course_Code=<?php echo $_SESSION['Course_Code']?>&studno=<?php echo $_SESSION['studno']?>&chk=1&ctr_exer=<?php echo $ctr_exer?>&ctr_quiz=<?php echo $ctr_quiz?>'" />
							<?php
						}?>
						<input type="button" class='button' value="Cancel" onclick="location='Grading.php?Course_Code=<?php echo $_SESSION['Course_Code']?>&studno=<?php echo $_SESSION['studno']?>&chk=0&ctr_exer=<?php echo $ctr_exer?>&ctr_quiz=<?php echo $ctr_quiz?>'"/>
				</td>
			</tr></br>
		</table>
	</form>
